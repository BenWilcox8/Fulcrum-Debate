...
│   ├── formatting/         Evidence formatting standards model: FormattingProfile, DEFAULT_FORMATTING_PROFILE, and preferences-store section registration (registerFormattingSection, readFormattingProfile)
