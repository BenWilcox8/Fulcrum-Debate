...
│   ├── tools/              Card-cutting tool registration contract (createCardToolRegistry, toolSectionDefinition, CardToolDefinition, RegisteredCardTool, CARD_TOOL_DEFINITIONS) - the shared seam every card-cutting tool plugs into; ships the Condense tool (condense.ts, canCondenseSelection)
...
│   │   └── demo/           Demo card tool that proves the seam end-to-end (kept as a reference alongside real tools)
